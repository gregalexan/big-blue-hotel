        ...
        <div className="container-sm">
            <div className="four-photos-row">
                <div className="four-photos-column">
                    <Image
                        src="/assets/images/A3/Big_Blue_Hotel_Room_A3_5.jpg"
                        ...
                        priority={true}
                        placeholder='blur'
                        blurDataURL='/assets/images/A3/Big_Blue_Hotel_Room_A3_5.jpg'
                    />
                    <Image
                        src="/assets/images/BigBlue/Big_Blue_Hotel_Room_BigBlue_3.jpg"
                        ...
                        priority={true}
                        placeholder='blur'
                        blurDataURL='/assets/images/BigBlue/Big_Blue_Hotel_Room_BigBlue_3.jpg'
                    />
                </div>
                <div className="four-photos-column">
                    <Image
                    ...
                    />
                    <Image
                        src="/assets/images/A2/Big_Blue_Hotel_Room_A2_15.jpg"
                        ...
                        priority={true}
                        placeholder='blur'
                        blurDataURL='/assets/images/A2/Big_Blue_Hotel_Room_A2_15.jpg'
                    />
                </div>
            </div>
        </div>
