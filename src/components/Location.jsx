            ...
            {isGreek ? (
                <>
                    ...
                    <div className="map-container">
                        ...
                        <a className="btn btn-primary" href="/greek/location" aria-label="Το Big Blue Hotel βρίσκεται στην Αμαλιάπολη και παρέχει μερικές πληροφορίες για την Αμαλιάπολη. Η Αμαλιάπολη είναι πολύ κοντά στον Αλμυρό και τον Βόλο, στη Μαγνησία">
